    ...
    periods: [
      {
        ...
        events: [
          ...
          {
            id: 'downsizing',
            title: 'Дом становится большим',
            scene: '🏠',
            text: 'Дети выросли и разъехались. Старый дом кажется слишком просторным и тихим.',
            choices: [
              {
                text: 'Переезжаешь в квартиру поменьше',
                effects: { stats: { money: 10, happy: 1 }, path: { practical_elder: 1 } },
              },
              {
                text: 'Остаёшься в доме — тут вся жизнь',
                effects: { stats: { happy: 3, money: -3 }, path: { sentimental: 1 } },
              },
            ],
          },
          {
